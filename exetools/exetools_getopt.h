...
#if !defined( _EXETOOLS_GETOPT_H )
#define _EXETOOLS_GETOPT_H
...
typedef struct exetools_option exetools_option_t;

struct exetools_option
{
...
#define exetools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t exetools_getopt(
                  int argument_count,
...
void exetools_getopt_wrapped_fprint(
      FILE *stream,
...
void exetools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const exetools_option_t *options,
      int number_of_options );

int exetools_getopt_get_options_string(
     const exetools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _EXETOOLS_GETOPT_H ) */
