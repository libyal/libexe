...
#if !defined( _LIBEXE_MZ_HEADER_H )
#define _LIBEXE_MZ_HEADER_H
...
typedef struct libexe_mz_header libexe_mz_header_t;

struct libexe_mz_header
{
...
#endif /* !defined( _LIBEXE_MZ_HEADER_H ) */
