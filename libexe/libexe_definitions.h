...
/* The characteristic flags definitions
 */
enum LIBEXE_CHARACTERISTIC_FLAGS
{
	LIBEXE_CHARACTERISTIC_FLAG_RELOCS_STRIPPED		= 0x0001,
	LIBEXE_CHARACTERISTIC_FLAG_EXECUTABLE_IMAGE		= 0x0002,
	LIBEXE_CHARACTERISTIC_FLAG_LINE_NUMS_STRIPPED		= 0x0004,
	LIBEXE_CHARACTERISTIC_FLAG_LOCAL_SYMS_STRIPPED		= 0x0008,
	LIBEXE_CHARACTERISTIC_FLAG_AGGRESSIVE_WS_TRIM		= 0x0010,
	LIBEXE_CHARACTERISTIC_FLAG_LARGE_ADDRESS_AWARE		= 0x0020,
	LIBEXE_CHARACTERISTIC_FLAG_16BIT_MACHINE		= 0x0040,
	LIBEXE_CHARACTERISTIC_FLAG_BYTES_REVERSED_LO		= 0x0080,
	LIBEXE_CHARACTERISTIC_FLAG_32BIT_MACHINE		= 0x0100,
	LIBEXE_CHARACTERISTIC_FLAG_DEBUG_STRIPPED		= 0x0200,
	LIBEXE_CHARACTERISTIC_FLAG_REMOVABLE_RUN_FROM_SWAP	= 0x0400,
	LIBEXE_CHARACTERISTIC_FLAG_SYSTEM			= 0x1000,
	LIBEXE_CHARACTERISTIC_FLAG_DLL				= 0x2000,
	LIBEXE_CHARACTERISTIC_FLAG_UP_SYSTEM_ONLY		= 0x4000,
	LIBEXE_CHARACTERISTIC_FLAG_BYTES_REVERSED_HI		= 0x8000
};
