/*
 * Library export_table type test program
 *
...
#include "../libexe/libexe_export_table.h"

#if defined( __GNUC__ )

/* Tests the libexe_export_table_initialize function
 * Returns 1 if successful or 0 if not
 */
int exe_test_export_table_initialize(
     void )
{
	...
	export_table = (libexe_export_table_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libexe_export_table_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libexe_export_table_initialize with memset failing
		 */
...
/* Tests the libexe_export_table_free function
 * Returns 1 if successful or 0 if not
 */
int exe_test_export_table_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	EXE_TEST_RUN(
	 "libexe_export_table_initialize",
	 exe_test_export_table_initialize );
